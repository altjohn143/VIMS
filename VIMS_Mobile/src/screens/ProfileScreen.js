...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: themeColors.primary, paddingTop: 56, paddingBottom: 18, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', width: '100%' },
  backButton: { padding: 8 },
  headerTitle: { color: 'white', fontSize: 20, fontWeight: '800' },
  content: { paddingTop: 24, paddingHorizontal: 16, paddingBottom: 24 },
  profileCard: { backgroundColor: 'white', borderRadius: 20, padding: 20, alignItems: 'center', marginBottom: 16, borderWidth: 1, borderColor: themeColors.border, ...shadows.small },
  ...
  section: { backgroundColor: 'white', borderRadius: 18, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: themeColors.border, ...shadows.small },
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'center', borderWidth: 1, borderColor: themeColors.borderStrong, borderRadius: 14, paddingHorizontal: 12, backgroundColor: themeColors.surfaceMuted, minHeight: 52 },
  input: { flex: 1, paddingVertical: 12, fontSize: 16, color: themeColors.textPrimary, marginLeft: 8 },
  securityButton: { flexDirection: 'row', alignItems: 'center', padding: 14, backgroundColor: themeColors.surfaceMuted, borderRadius: 14, borderWidth: 1, borderColor: themeColors.border },
  securityButtonText: { flex: 1, fontSize: 16, color: themeColors.textPrimary, marginLeft: 12 },
  saveButton: { backgroundColor: themeColors.primary, padding: 16, borderRadius: 14, marginTop: 8, marginBottom: 32, alignItems: 'center', ...shadows.small },
