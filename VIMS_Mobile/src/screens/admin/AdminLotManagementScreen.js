...
const styles = StyleSheet.create({
  ...
  statCard: { width: 112, backgroundColor: 'white', borderRadius: 18, padding: 14, borderWidth: 1, borderColor: themeColors.border },
  ...
  lotCard: { backgroundColor: 'white', borderRadius: 18, padding: 14, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: themeColors.primary },
  ...
  emptyState: { backgroundColor: 'white', borderRadius: 22, padding: 28, alignItems: 'center', borderWidth: 1, borderColor: themeColors.border },
  ...
  modalCard: { backgroundColor: 'white', borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 20, maxHeight: '82%' },
