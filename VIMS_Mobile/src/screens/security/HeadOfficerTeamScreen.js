...
const styles = StyleSheet.create({
  ...
  statCard: { flex: 1, backgroundColor: 'white', borderRadius: 14, padding: 14, ...shadows.small },
  statValue: { fontSize: 22, fontWeight: '900', color: themeColors.primary },
  statLabel: { fontSize: 12, color: themeColors.textSecondary, fontWeight: '700' },
