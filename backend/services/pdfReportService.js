...
class PDFReportService {
  ...
  _addReportFooter(doc, creator, generatedAt = new Date(), timezoneOffsetMinutes = 0) {
    ...
    for (let i = 0; i < pageCount; i++) {
      ...
      doc.text(this.publisherName, left, footerY + 10, this._getTextOptions({ width: usableWidth, align: 'center', lineBreak: false }));
      doc.text(`Page ${i + 1} of ${pageCount}`, left, footerY + 10, this._getTextOptions({ width: usableWidth, align: 'right', lineBreak: false }));
      doc.text(`Generated on ${this._formatDisplayDate(generatedAt, timezoneOffsetMinutes)}`, left, footerY + 22, this._getTextOptions({ width: usableWidth, align: 'center', lineBreak: false }));

      if (creator) {
        doc.text(`Generated by: ${this._formatCreator(creator)}`, left, footerY + 34, this._getTextOptions({ width: usableWidth, align: 'center', lineBreak: false }));
      }
    }
  }
