...
class PDFReportService {
  ...
  async generateFinancialReport(data, options = {}) {
    return new Promise((resolve, reject) => {
      try {
        ...
        this._addReportHeader(doc, 'VIMS Financial Report', data.period, data.year, data.month);
  ...
  async generateVisitorReport(data, options = {}) {
    return new Promise((resolve, reject) => {
      try {
        ...
        this._addReportHeader(doc, 'VIMS Visitor Security Report', data.period, data.date);
  ...
  async generateIncidentReport(data, options = {}) {
    return new Promise((resolve, reject) => {
      try {
        ...
        this._addReportHeader(doc, 'VIMS Incident Analysis Report', data.period, data.date);
  ...
  async generateDataReport(title, data, columns, options = {}) {
    return new Promise((resolve, reject) => {
      try {
        ...
        this._addReportHeader(doc, title, 'Generated', new Date().toLocaleDateString());
  ...
  _addReportHeader(doc, title, period, date, month) {
