      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Grid container spacing={2} sx={{ mb: 2 }}>
          {[
            ...
            { label: 'Completed', value: stats.completed, helper: 'resolved', gradient: 'linear-gradient(135deg, #003D07 0%, #007A18 52%, #00D084 100%)', shadow: '0 14px 34px rgba(0,208,132,0.34)' }
          ].map((stat) => (
          ...
          <Table>
            ...
            <TableBody>
              {paginatedRows.map((item) => (
                <TableRow key={item._id} hover sx={{ '&:hover': { backgroundColor: 'rgba(0, 208, 132, 0.04)' } }}>
                  <TableCell>
